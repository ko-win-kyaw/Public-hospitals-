...
function getDisplayNameWithBadge(d) {
    ...
    if (d.isCrown) {
        ...
        badge = '<span class="badge-official gold-bg" style="background: linear-gradient(45deg, #a020f0, #ff00ff); color: white; padding: 2px 6px; border-radius: 4px; font-size: 10px; margin-left: 5px;">💰 Crown</span>';
