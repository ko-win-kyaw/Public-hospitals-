...
auth.onAuthStateChanged(async (user) => {
    ...
    if (user) {
        try {
            ...
            // ၂။ Device Lock စစ်ဆေးခြင်း (User အဟောင်း/အသစ် မငြိအောင် Logic ပြင်ထားသည်)
            if (doc.exists) {
                const existingData = doc.data();
                
                /** * ရှင်းလင်းချက်-
                 * - currentDevId က timeout ဖြစ်မနေရဘူး။
                 * - database ထဲမှာ deviceId ရှိပြီးသား ဖြစ်ရမယ်။ (ဒါမှ User အဟောင်းတွေ Lock မမိမှာပါ)
                 * - database ထဲက ID နဲ့ အခု ID မတူမှသာ Logout လုပ်မယ်။
                 */
            ...
            // ၃။ Data Update လုပ်ခြင်း (User အသစ် သို့မဟုတ် ID မရှိသေးသော အဟောင်းများကို ID သတ်မှတ်ပေးခြင်း)
            ...
            // Device ID က timeout မဖြစ်မှသာ သိမ်းဆည်းမည်
            ...
            // ၄။ Auto Friend System (မူရင်း Logic မပျက်အောင် ထည့်ထားသည်)
