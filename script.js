...
auth.onAuthStateChanged(async (user) => {
    ...
    if (user) {
        ...
        // ၄။ Auto Friend System (Flag စစ်ပြီး တစ်ကြိမ်သာ အလုပ်လုပ်မည်)
        // doc ထဲမှာ data မရှိသေးရင် (အကောင့်သစ်ဆိုရင်) ဒါမှမဟုတ် flag မရှိသေးရင် ခေါ်မယ်
        ...
        // ၆။ Notifications စတင်ခြင်း (ရှိလျှင်)
    ...
    // ၇။ Post များ Load လုပ်ခြင်း (တစ်ကြိမ်သာ)
...
function renderPostHTML(id, d, uid, isAdmin) {
    ...
    // ၃။ UI ပြသခြင်း (အချိန် ရက်စွဲ ပါဝင်သည်)
    return `
