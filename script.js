        ...
        if (d.mediaType === 'video') {
            ...
            media = `
                <div style="margin-top:10px; background:#000; border-radius:8px; overflow:hidden;">
                    <video src="${finalVideoUrl}" onplay="incrementView('${id}')" preload="metadata" playsinline webkit-playsinline style="width:100%; display:block; border-radius:8px; cursor:pointer;"></video>
                </div>`;
        } else {
            // Multiple images
