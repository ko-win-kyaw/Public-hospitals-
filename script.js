...
}, { threshold: [0, 0.8] }); // ၀% နှင့် ၅၀% မြင်ရမှုကို စစ်ဆေးမည်
...
function loadPosts() {
    db.collection("health_posts").orderBy("createdAt", "desc").onSnapshot(snap => {
        ...
        // --- ဤနေရာတွင် observeVideos() ကို ခေါ်ပေးရမည် ---
        setTimeout(() => {
            observeVideos();
        }, 500); // ပို့စ်တွေ HTML ထဲရောက်ဖို့ ခဏစောင့်ပြီးမှ Video တွေကို စောင့်ကြည့်ခိုင်းခြင်း
    });
}
